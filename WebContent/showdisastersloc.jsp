	...
	<br><br>
		...
		<div id="menu">
         ...
         <li><a href="showdisasters.jsp">Show Disasters</a></li>
   			<li><a href="#">Show Disasters as per Location</a></li>
...
<h2> Disasters As Per Location</h2>
	...
	<%-- 	<form action="disaster2.jsp">
		<select name="loc">
		
	<option value="">---Select---</option>	
	<option value="flood"><%=rs.getString("poststatus") %></option>
...
{
	%>
	<option value="<%=rs.getString("lat") %>,<%=rs.getString("lon") %>"><%=rs.getString("lat") %>,<%=rs.getString("lon") %></option>
		<%
}
%>
</select>

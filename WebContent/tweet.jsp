...
PreparedStatement ps = con.prepareStatement("select * from status where userid!=?");
ps.setString(1, userid1);
ResultSet rs =ps.executeQuery();
while(rs.next())
{
	%>
	<table border="1" style="background-color: grey; color: white;">
	<tr>
	<th>UserName</th>
	<td><%=GF.getFullName(Integer.parseInt(rs.getString("userid"))) %></td>
	</tr>
	<tr>
	<th>Place</th>

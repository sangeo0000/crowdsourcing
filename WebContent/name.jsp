...
<div id="footer">
	...
	<div class="container">
<h2>User Name Based Filter Tweets</h2>		<br />

<form action="name.jsp" align="left">
Select Name: 
...
<form action="name.jsp" align="right">
       ...
       <th>Name</th>
        <th>Tweet</th>
         <th>GeoLacation</th>
            ...
            PreparedStatement ps1 = con.prepareStatement("select s.poststatus,s.lat,s.lon from user_info u,status s where u.fname='"+name+"' and u.id=s.userid");

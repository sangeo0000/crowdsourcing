...
<h2>User Tweet Date Based Filter Tweets</h2>	<br />



<form action="date.jsp" >
Enter Name:<input type="date" name="name" required>
       ...
       <th>Name</th>
        <th>Tweet</th>
         <th>GeoLacation</th>
            ...
            PreparedStatement ps1 = con.prepareStatement("select * from status where postDate like '%"+name+"%' ");
